  ...
  return (
    <div className="border rounded-lg bg-muted">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-2 hover:bg-secondary/80 transition-colors"
      >
      ...
      {isExpanded && (
        <div className="px-4 pb-4 space-y-4 border-t">
          ...
          {/* 告警来源 */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">告警来源</label>
            <select
          ...
          {/* 持续时长筛选 */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">持续时长</label>
          ...
          {/* 特殊状态筛选 */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">特殊状态</label>
            <div className="flex gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-foreground">抖动告警</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-primary rounded focus:ring-blue-500"
                />
                <span className="text-sm text-foreground">长时间未更新</span>
              </label>
            </div>
          </div>
          ...
          {/* 处理人筛选 */}
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">处理人</label>
            <select
